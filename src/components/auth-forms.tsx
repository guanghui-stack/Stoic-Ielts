...
export function LoginForm() {
  ...
  return (
    <form action={action} className="space-y-5">
      ...
      {/* Thẻ <a> chứ không phải nút gọi JavaScript: luồng OAuth là một chuỗi
          chuyển trang thật của trình duyệt, và route /api/auth/google cần
          đặt được cookie `state` trước khi rời khỏi site. */}
