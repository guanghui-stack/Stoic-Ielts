    ...
    <form action={formAction} className="mt-6 border border-gold bg-gold-pale p-6">
      ...
      <div className="mt-4 flex flex-wrap items-end gap-3">
        ...
        <button
          type="submit"
          disabled={pending}
          className="cursor-pointer border border-gold bg-gold px-6 py-2.5 font-ui text-[0.78rem] font-semibold uppercase tracking-[0.1em] text-navy-deep transition-colors hover:border-gold-soft hover:bg-gold-soft disabled:opacity-50"
        >
