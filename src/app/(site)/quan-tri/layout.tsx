...
/**
 * Tab "Tuyển chọn" chỉ hiện khi cờ ba cấp thử thách được bật. Hiện một tab dẫn
...
const TABS = [
  ...
  { href: "/quan-tri/cuoc-thi", label: "Thử thách tháng" },
  { href: "/quan-tri/nghi-su-duong", label: "Diễn đàn" },
  { href: "/quan-tri/thi-but", label: "Tự vấn" },
  { href: "/quan-tri/liem-chinh", label: "Liêm chính" },
