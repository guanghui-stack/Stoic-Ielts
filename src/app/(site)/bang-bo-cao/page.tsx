...
export const metadata = {
  title: "Bảng Bố Cáo",
  description:
    "Tin vinh danh của HỔ PHÙ · IELTS: người thăng cấp bậc cao, danh hiệu vừa trao và kết quả mùa giải.",
};
  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-6 py-12">
      ...
      <p className="mt-3 max-w-2xl text-[1rem] leading-relaxed text-ink-soft">
        Nơi này chỉ đăng tin vinh danh: người thăng lên nhóm cấp bậc cao nhất,
        danh hiệu vừa được trao, và kết quả mỗi mùa giải. Không có tin xấu nào
        lên bảng này, và đó là luật của hệ thống chứ không phải thói quen biên
        tập.
      </p>
      ...
      <section className="mt-10 border border-line bg-paper p-6">
        ...
        <p className="mt-3 text-[0.94rem] leading-relaxed text-ink-soft">
          {owner
            ? `${FACTION_LABEL[owner]} đang giữ lãnh địa, giành được từ mùa trước và giữ tới hết mùa này.`
            : "Chưa phe nào giữ lãnh địa. Mùa đầu tiên còn đang diễn ra."}
        </p>
        ...
        {leader && leader.score > 0 ? (
          ...
          <p className="mt-4 font-ui text-[0.94rem] text-ink-soft">
            Chưa phe nào ghi được điểm mùa này.
          </p>
        )}
